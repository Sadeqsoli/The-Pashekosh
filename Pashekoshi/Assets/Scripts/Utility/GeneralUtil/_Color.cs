...
public static class _Color
{
    ...
    public static Color R_ToastRed
    {
        get
        {
            Color falseRedColor = new Color(1f, 0.2941177f, 0.2941177f, 0.4f);
            return falseRedColor;
        }
    }
    ...
    public static Color G_TrueGreen
    {
        get
        {
            Color lightGreenColor = new Color(0.2941177f, 1f, 0.2941177f, 1f);
            return lightGreenColor;
        }
    }

    public static Color G_ToastGreen
    {
        get
        {
            Color lightGreenColor = new Color(0.2941177f, 1f, 0.2941177f, 0.4f);
            return lightGreenColor;
        }
    }
    ...
    public static Color HalfOpacity
    {
        get
        {
