...
public class GameManager : Singleton<GameManager>
{
    ...
    public static bool haveDiedBefore { private set; get; }
    ...
    private void LoadLevel()
    {
        ...
        gameUIManager.ToastBuilder.SendToast((currentLevel + 1).ToString());
    ...
    private void ShowHideSettingPanel(bool isPanelOn)
    {
        ...
        if (isPanelOn)
        {
            ...
            settingPanel.CloseButton?.onClick.AddListener(()=>
            { 
                // Play the game again
                PlayPauseGame(false);
