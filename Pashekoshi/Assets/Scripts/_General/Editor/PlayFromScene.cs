...
public class PlayFromScene : EditorWindow
{
    ...
    //[MenuItem("Play/Play From Scene %0")]
    ...
    void OnGUI()
    {
        ...
        {
            EditorSceneManager.activeSceneChangedInEditMode += Scenes;
            EditorSceneManager.SaveCurrentModifiedScenesIfUserWantsTo();
            EditorSceneManager.OpenScene(waitScene);
        }
    }

    void Scenes(Scene scene1, Scene scene2)
    {
        lastScene = scene1.name;
        waitScene = scene2.name;
    }
    ...
    [MenuItem("Play/Play-Stop, Start Scene %.")]
